...
public class OrganizationalUnit
{
	...
	/// <summary>
	/// Converts an organizational unit to a URL friendly structure (i.e. the Aluvii node is replaced by <see cref="OrganizationalUnitConfig.BaseOrganizationalUnit"/>).  
	/// </summary>
	/// <returns></returns>
